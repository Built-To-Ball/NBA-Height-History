...
$(document).ready(function() {
  ...
  avgSVG.attr("height", avglheight).attr("width", avglwidth);
  ...
  var yearInfoDisp = avgSVG
    .append("g")
    .attr("class", "yearInfo")
    .attr("transform", "translate(450, 275)");

  yearInfoDisp
    .append("text")
    .attr("id", "yearInfoYear")
    .attr("y", 0);
  yearInfoDisp
    .append("text")
    .attr("id", "yearInfoValue")
    .attr("y", 20);
  ...
  d3.csv("data/player_data.csv", function(error, players) {
    ...
    d3.selection.prototype.showYearInfo = function(d) {
      ...
      avgSVG
        .select("#yearInfoYear")
        .text("Year: " + yearInfo.x)
        .style();
      avgSVG
        .select("#yearInfoValue")
        .text("Average Height: " + yearInfo.y.toFixed(2) + " in");
      return this;
    };
